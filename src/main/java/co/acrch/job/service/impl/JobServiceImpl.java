package co.acrch.job.service.impl;

import co.acrch.common.annotation.CronTag;
import co.acrch.common.service.impl.BaseService;
import co.acrch.job.dao.JobMapper;
import co.acrch.job.domain.Job;
import co.acrch.job.service.JobService;
import co.acrch.job.util.ScheduleUtils;
import co.acrch.common.annotation.CronTag;
import co.acrch.common.service.impl.BaseService;
...
public class JobServiceImpl extends BaseService<Job> implements JobService {
    ...
    public List<Job> getSysCronClazz(Job job) {
        Reflections reflections = new Reflections("co.acrch.job.task");
