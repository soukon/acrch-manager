...
import co.acrch.common.annotation.Limit;
import co.acrch.common.domain.LimitType;
...
/**
 * 接口限流注解，示例见 co.acrch.common.controller.TestController
 */
@Aspect
@Component
public class LimitAspect {
    ...
    @Pointcut("@annotation(co.acrch.common.annotation.Limit)")
