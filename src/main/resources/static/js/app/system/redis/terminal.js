var $MB_Redis_Bash = function () {
    $(document).ready(function () {
        ...
        printf("Last login: " + date + " on acrchManager, type `help` for help\n");
        displayPrompt();
        ...
        function help(arg) {
            ...
            if (hasArgs(arg)) {
                ...
                printf(" Redis bash with SpringBoot by <a href='http://www.acrch.co.jp/' class='kw_b'>Acrch</a>, version v0.0.1 - Snapshot \n");
